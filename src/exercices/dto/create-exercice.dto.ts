...
export class CreateExerciceDto {
    ...
    @ApiProperty({ example: "The glute bridge effectively works your entire posterior chain, which isn't only good for you, but it will make your booty look perkier as well.", description: 'Описание' })
